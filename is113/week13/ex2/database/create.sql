drop database if exists week13ex2;
create database week13ex2;
use week13ex2;
...
insert into account (email, fullname, pass) values ('donald@trump.com', 'Donald Trump', '$2y$10$h.IgQD4s28VppNZSrgNXNutTT272hEIOjj0nulqrqF7w0a.KSzIUe');
insert into account (email, fullname, pass) values ('hillary@clinton.com', 'Hillary Clinton', '$2y$10$tJluGYzd1W8LxaUuC6Qn1uVDaK1V42cZkUEqGrsuLSpjAnjL/Rm/2');
